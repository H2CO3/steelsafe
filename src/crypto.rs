...
/// entropy, which just exceeds the length of the XChaCha20Poly1305 key. This ensures that
/// passwords generated by this tool do not decrease the security of the hashing, encryption,
/// and authentication.
